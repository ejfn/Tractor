...
- **[AGENTS.md](AGENTS.md)** - Development guidelines and project architecture (CLAUDE.md symlinks here)
...
Development guidelines are documented in [AGENTS.md](AGENTS.md) (following the [agents.md](https://agents.md/) standard).
