...
export const DEALING_SPEED = 250; // Speed of card dealing animation during progressive dealing
...
export const STATE_UPDATE_SYNC_DELAY = 250; // Short delay to ensure state updates happen together
